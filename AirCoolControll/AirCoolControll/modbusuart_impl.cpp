...
ModBusUART_Impl::ModBusUART_Impl(const QSerialPortInfo& info, QObject *parent)
    : QObject(parent),
    m_port(this)
{
...
qint16 ModBusUART_Impl::readRegister(quint16 id, quint16 regNumber)
{
    static const quint16 registersCount = 1;
    QByteArray data = QByteArray::fromRawData((const char*)& regNumber, sizeof(quint16));
    data += QByteArray::fromRawData((const char*)& registersCount, sizeof(quint16));
